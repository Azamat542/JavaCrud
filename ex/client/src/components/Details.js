                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">Price: <span >{getuserdata.age}</span></h3>
                            <p className="mt-3"><MailOutlineIcon />Contact Email: <span>{getuserdata.email}</span></p>
                        </div>
                        <div className="right_view  col-lg-6 col-md-6 col-12">

                            <p className="mt-5"><PhoneAndroidIcon />mobile: <span>+7 {getuserdata.mobile}</span></p>
